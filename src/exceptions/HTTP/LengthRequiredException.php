...
/**
 * Length Required HTTP層実行例外
 *
 * ｸﾗｲｱﾝﾄがContent-Lengthﾍｯﾀﾞを送信しなければならない事を示す例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>ﾘｿｰｽ操作にはContent-Lengthﾍｯﾀﾞが必須となるが､ｸﾗｲｱﾝﾄからのﾘｸｴｽﾄには､指定されていなかった場合に利用される</li>
 * </ul>
 *

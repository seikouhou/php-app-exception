...
/**
 * Unauthorized HTTP層実行例外
 *
 * 認証情報を間違えている事を示す例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>認証情報が渡されなかったり､間違っていた場合に利用される</li>
 *     <li>ﾚｽﾎﾟﾝｽにはWWW-Authenticateﾍｯﾀﾞが含まれ､そこで認証方式を指定する</li>
 * </ul>
 *

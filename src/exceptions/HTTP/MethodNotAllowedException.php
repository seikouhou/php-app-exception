...
/**
 * Method Not Allowed HTTP層実行例外
 *
 * 指定したﾒｿｯﾄﾞがｻﾎﾟｰﾄされていない事を示す例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>あるURIが指定したﾒｿｯﾄﾞをｻﾎﾟｰﾄしていない場合に利用される</li>
 *     <li>ﾚｽﾎﾟﾝｽにはAllowﾍｯﾀﾞが含まれ､そこでこのURIがｻﾎﾟｰﾄするﾒｿｯﾄﾞの一覧を指定する</li>
 * </ul>
 *

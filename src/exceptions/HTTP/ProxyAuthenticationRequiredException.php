...
/**
 * Proxy Authentication Required HTTP層実行例外
 *
 * ﾌﾟﾛｷｼ認証が必要である事を示す例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>ﾌﾟﾛｷｼ認証がされていない場合に利用される</li>
 *     <li>ﾚｽﾎﾟﾝｽにはProxy-Authenticateﾍｯﾀﾞが含まれ､そこで認証方式を指定する</li>
 * </ul>
 *
...
class ProxyAuthenticationRequiredException extends HttpException
{
     ...
     */
    protected $defMessage = 'Proxy Authentication Required';
    /**
     * @api
     * @var string ｺﾝｽﾄﾗｸﾀの引数<var>$message</var>が配列で渡された場合にvsprintfに渡すﾌｫｰﾏｯﾄ文字列
     */
    protected $messageTemplate = 'Proxy Authentication Required';
    /**
     * @api
     * @var int ｺﾝｽﾄﾗｸﾀの引数<var>$code</var>が渡されなかった場合の既定の例外ｺｰﾄﾞ
     */
    protected $defCode = 407;
    /**
     * @api

...
/**
 * Service Unavailable HTTP層実行例外
 *
 * ｻｰﾋﾞｽの提供ができない事を示す例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>ﾒﾝﾃﾅﾝｽなどでｻｰﾋﾞｽの提供ができない場合に利用される</li>
 * </ul>
 *

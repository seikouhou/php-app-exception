 ...
 * 一時的な失敗での実行例外
 *
 * 一時的に処理が失敗した場合に使用する例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>一時的に処理が失敗した場合に利用する</li>
 *     <li>一時的というのは再実行時に成功する可能性がある事を意味する</li>
 * </ul>
 *

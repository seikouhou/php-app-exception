 ...
 * 要求要素非存在時の実行例外
 *
 * 要求した要素が存在しなかった場合に使用する例外です
 *
 * ◆詳細◆
 * <ul>
 *     <li>要求した要素が存在しなかった場合に利用する</li>
 *     <li>例)ﾌｧｲﾙが存在しなかった</li>
 *     <li>例)ﾚｺｰﾄﾞが存在しなかった</li>
 *     <li>例)URLが存在しなかった</li>
 * </ul>
 *
